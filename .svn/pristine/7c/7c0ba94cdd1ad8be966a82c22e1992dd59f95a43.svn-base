...
public class MainPageObject extends PageBase{
	private util u;
	...
	public boolean waitTaskCompleted(final String taskDoneText){	
	     ...
	     ExpectedCondition<Boolean> expectation = new
	        ...
	        public Boolean apply(WebDriver driver) {
			   ...
			   waitAndClickElement(driver,By.xpath(".//*[@id='_refresh']"),60);	
			   switchTaskList1Frame();
			   return   ExpectedConditions.textToBePresentInElementLocated(By.xpath("//td[text()='59577_task']/following-sibling::td[2]"), taskDoneText).equals(false);
	        }
	      };
