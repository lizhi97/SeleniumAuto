...
public class TestCase54208 extends AvalanchePageTestCasesBase{
	 ...
	 public void test1(String url,String username,String password,String mdproname){
		 ...
		 ppo.DeleteProfileInputByOrder(ppo.getPorfileNameOrder("002-winsy"));
		 System.out.println("54208 finish running");
